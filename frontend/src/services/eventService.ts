...
const MOCK_EVENTS: Event[] = [
  {
    ...
    description:
      "A 24-hour coding event where students collaborate to build innovative solutions to real-world problems.",
    date: "2025-06-15",
    ...
    registered: 78,
    imageUrl:
      "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
  ...
  },
  {
    ...
    description:
      "Featuring performances from student bands, local artists and our award-winning college orchestra.",
    date: "2025-05-20",
    ...
    registered: 423,
    imageUrl:
      "https://images.unsplash.com/photo-1501612780327-45045538702b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
  ...
  },
  {
    ...
    description:
      "Connect with over 50 top employers looking to hire students and recent graduates.",
    date: "2025-04-10",
  ...
  },
  {
    ...
    description:
      "Learn about sustainability practices and how you can contribute to a greener campus.",
    date: "2025-03-22",
    ...
    registered: 42,
    imageUrl:
      "https://images.unsplash.com/photo-1532094349884-543bc11b234d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80",
  ...
  },
  {
    ...
    description:
      "Opening ceremony for the annual inter-college sports competition featuring 12 different sports.",
    date: "2025-07-05",
  ...
  },
  {
    ...
    description:
      "Taste dishes from around the world prepared by our multicultural student community.",
    date: "2025-04-18",
...
export const getUserRegistrations = async (
  userId: string
): Promise<{ event: Event; registration: Registration }[]> => {
  // Simulate API call delay
  await new Promise((resolve) => setTimeout(resolve, 700));

  const registrations = MOCK_REGISTRATIONS.filter(
...
export const cancelRegistration = async (
  ...
  const index = MOCK_REGISTRATIONS.findIndex(
...
export const deleteEvent = async (eventId: string): Promise<void> => {
  ...
  const regIndices = MOCK_REGISTRATIONS.map((reg, i) =>
    reg.eventId === eventId ? i : -1
  )
    .filter((i) => i !== -1)
    .sort((a, b) => b - a);
